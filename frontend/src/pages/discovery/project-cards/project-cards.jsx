  ...
  const handleCompare = (project) => {
    try {
      ...
      const item = {
        ...
        fundingRequired: full.financials?.funding_required ?? full.funding_required ?? 0,
        durationMonths: full.timeline?.duration_months ?? full.duration_months ?? null,
        pastProjectsCompleted: full.ngo_credibility?.past_projects_completed ?? full.past_projects_completed ?? null,
