      ...
      <div className="flex gap-8">
        ...
        <section className="flex-1">
          <div className="mb-6 flex items-center justify-between">
            ...
            <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="border border-gray-300 rounded-xl px-4 py-2">
          ...
          <div className="mt-8 flex justify-center">
            <button className="px-6 py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">Load More Projects</button>
          </div>
        </section>
      </div>
    </div>
